...
<p align="center"> <img src="https://via.placeholder.com/600x300.png?text=Insert+Your+Vending+Machine+Diagram+Here" alt="Vending Machine Diagram" width="70%"> </p>
:sparkles: Features
Mealy State Machine based design for deterministic outputs.
Coin Input : Accepts and tracks coin insertions (e.g., 5¢, 10¢, 25¢).
Product Dispensing : Dispenses product automatically when full amount is reached.
Change Output : Calculates change if user inserts more than required.
...
If the total inserted ≥ the product price, the machine transitions to a dispense state.
...
<p align="center"> <img src="https://via.placeholder.com/500x300.png?text=Insert+Flow+Diagram" alt="Vending Machine Flow Diagram" width="60%"> </p>
...
(Feel free to insert an actual screenshot or a snippet of your waveform here.)
